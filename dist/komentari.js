                ...
                React.createElement("div", { style: { display: "flex" } },
                    ...
                    (username == el.komentator || isAdmin) &&
                        React.createElement("form", { action: "/obrisikomentar", method: "post" },
                            ...
                            React.createElement("input", { type: "submit", defaultValue: "Obri\u0161i komentar" }))),
                React.createElement("p", null, datum),
                username == el.komentator ?
                    React.createElement("form", { action: "/azurirajkomentar", method: "post" },
                        React.createElement("input", { type: "hidden", name: "id", defaultValue: el.id }),
                        React.createElement("textarea", { name: "tekst", defaultValue: el.tekst, width: "100" }),
                        React.createElement("input", { type: "submit", defaultValue: "Uredi komentar" })) : React.createElement("p", null, el.tekst),
                React.createElement("hr", null)));
        }),
        username &&
